...
namespace OneMightyRoar\PHP_Paulus_Components\Support;

/**
 * ArrayUtilities
 *
 * Static array utilities...
 * because function auto-loading sucks in PHP 5.4
 *
 * @package OneMightyRoar\PHP_Paulus_Components\Support
 */
class ArrayUtilities
{

    /** 
     * Merge arrays recursively... but do it right
     *
     ...
     * @author Trevor Suarez (I just modified it to make it PSR-2)
     */
